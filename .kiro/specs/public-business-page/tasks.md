...
- [ ] 1. RLS policies a databázové základy
  - [ ] 1.1 Migrace: anon read policy pro `businesses`, `services`, `opening_hours`
  ...
  - [ ] 1.2 Migrace: deny anon na `reservations` (read i insert)
...
- [ ] 2. Slug normalizace a routing utility
  - [ ] 2.1 Helper `normalizeSlug` + check Reserved_Slug
...
- [ ] 3. PublicProfileRenderer a /[slug] routa
  - [ ] 3.1 Komponenta `PublicProfileRenderer`
  ...
  - [ ] 3.2 Routa `app/[slug]/page.tsx` se stavovou dispatch logikou
  ...
  - [ ]* 3.3 Property test: case-insensitivita slugu
  ...
  - [ ]* 3.4 Snapshot test `PublicProfileRenderer` (3 stavy)
...
- [ ] 4. SEO metadata, JSON-LD, sitemap, robots
  - [ ] 4.1 `generateMetadata` per stav stránky
  ...
  - [ ] 4.2 Inline JSON-LD `LocalBusiness`
  ...
  - [ ]* 4.5 Property test: korektnost sitemap
  ...
  - [ ]* 4.6 Snapshot test `SeoMetadata` (3 stavy)
    - `tests/components/SeoMetadata.spec.ts`
    - Snapshoty výstupu `generateMetadata` pro publikovaný / nepublikovaný / 404 stav
    - _Requirements: 12.1, 12.2, 12.4_

- [ ] 5. Checkpoint — veřejná vrstva
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 6. Rezervační formulář — client component (5 kroků)
  - [ ] 6.1 `ReservationFormController` skeleton
  ...
  - [ ] 6.3 Krok 2 — výběr data + volání `AvailableSlotsService`
  ...
  - [ ]* 6.7 Snapshot test `ReservationFormController` per krok
...
- [ ] 7. Server actions a notifikace
  - [ ] 7.1 `AvailableSlotsService` server action
  ...
  - [ ] 7.2 `ReservationCreator` server action — atomický blok
  ...
  - [ ] 7.3 `EmailNotifier` přes Resend (dvě šablony)
  ...
  - [ ]* 7.4 Property test: atomicita vytvoření rezervace
  ...
  - [ ]* 7.5 Property test: přiřazení statusu
  ...
  - [ ]* 7.6 Property test: e-mail best-effort
  ...
  - [ ]* 7.7 Property test: totalita server-side validace
  ...
  - [ ]* 7.8 Property test: citlivá data nejsou v lozích
...
- [ ] 8. Integrační a E2E testy
  - [ ]* 8.1 Integration test: race condition na stejný slot
  ...
  - [ ]* 8.2 Integration test: ISR revalidation po CRUD
  ...
  - [ ]* 8.3 Integration test: anon RLS nemůže číst `reservations`
...
- [ ] 9. Provozní dokumentace
  - [ ] 9.1 Operational note: úprava Cloudflare WAF rate limit cesty
