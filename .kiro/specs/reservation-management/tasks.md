...
- [x] 1. Databázové základy — migrace a RLS
  - [x] 1.1 Migrace: sloupce `status_reason` a `attendance`
  ...
  - [x] 1.2 Migrace: RLS policies pro dashboard majitele
  ...
  - [x]* 1.3 Integrační test: RLS izolace
...
- [x] 2. Sdílené refaktorizace (dotýkají se `public-business-page` — zachovat chování)
  - [x] 2.1 Extrakce `lib/reservations/atomicSlotWrite`
  ...
  - [x]* 2.2 Ověření stávajících property testů `ReservationCreator`
  ...
  - [x] 2.3 Konsolidace `Email_Dispatcher` do `lib/email`
  ...
  - [x]* 2.4 Ověření stávajících e-mailových testů `public-business-page`
...
- [x] 3. E-mailové šablony této feature
  - [x] 3.1 Čtyři české šablony v `lib/email/templates`
  ...
  - [x]* 3.2 Snapshot testy čtyř šablon
...
- [x] 4. Active_Subscription_Gate middleware
  - [x] 4.1 Middleware pro `/dashboard/*`
  ...
  - [x]* 4.2 Integrační test brány předplatného
    - `tests/integration/subscription-gate.spec.ts` — status mimo množinu → redirect; nepřihlášený → `/login`; aktivní → přístup
    - _Requirements: 1.1, 1.2, 1.3_

- [x] 5. Checkpoint — základy a sdílené komponenty
  - Ensure all tests pass, ask the user if questions arise.

- [x] 6. Seznam a detail rezervací (čtecí vrstva)
  - [x] 6.1 `Reservations_List` + `Reservations_Filter_Bar` + `Reservations_Table_View` + stránkování
  ...
  - [x] 6.2 `Reservations_Calendar_View`
  ...
  - [x] 6.3 Prezentační utilita českého mapování
  ...
  - [x]* 6.5 Snapshot testy `Table_View` / `Calendar_View`
  ...
  - [x]* 6.6 Příkladové testy `Reservation_Detail_View`
  ...
  - [x]* 6.7 Integrační test filtrů a stránkování
...
- [x] 7. Stavové přechody a docházka
  - [x] 7.1 `Reservation_Approver`
  ...
  - [x]* 7.5 PBT: validita stavových přechodů
  ...
  - [x]* 7.6 Příkladový test časové brány docházky
...
- [x] 8. Checkpoint — čtení a stavové přechody
  - Ensure all tests pass, ask the user if questions arise.

- [x] 9. Úprava, mazání a ruční tvorba rezervace
  - [x] 9.1 `Reservation_Editor`
  ...
  - [x] 9.3 `Manual_Reservation_Creator`
  ...
  - [x]* 9.4 PBT: atomicita úpravy (vyloučení sebe sama)
...
- [x] 10. Evidence klientů
  - [x] 10.1 `Client_Upsertor` (sdílený, po commitu)
  ...
  - [x]* 10.5 PBT: determinismus upsertu klienta
  ...
  - [x]* 10.6 PBT: úplnost anonymizace
  ...
  - [x]* 10.7 Příkladový test prázdného stavu `Client_Detail_View`
    - `tests/components/client-detail-empty.spec.tsx` — hláška „Klient zatím nemá žádné rezervace"
    - _Requirements: 14.5_

  - [x]* 10.8 Integrační test časování upsertu
  ...
  - [x]* 10.9 Integrační test atomicity anonymizace
...
- [x] 11. CSV export
  ...
  - [x]* 11.2 PBT: round-trip CSV escapingu
  ...
  - [x]* 11.3 PBT: citlivá data nejsou v lozích
  ...
  - [x]* 11.4 Příkladový test CSV hlavičky a kódování
  ...
  - [x]* 11.5 Integrační test rozsahu CSV
...
- [x] 12. Checkpoint — mutace, klienti a export
  - Ensure all tests pass, ask the user if questions arise.

- [x] 13. Propojení dashboardu a E2E
  - [x] 13.1 Propojení akcí a navigace
  ...
  - [x]* 13.2 E2E: schválení rezervace
